...
const ConsultaSubmitXmlModal = (props, ref) => {
 ...
 console.log("Profile", currentAppointment)
  return (
                                            ...
                                            <div className="flex flex-col gap-4">
                                                ...
                                                <div className="flex flex-col gap-4 mt-8">
                                                    ...
                                                    <div className="grid grid-cols-2">
                                                        ...
                                                        <span className="font-semibold">
                                                          {currentAppointment?.status === null ? 'Second Tranche' : ' '}
                                                        </span>
                                                    </div>
                                                    <div className="grid grid-cols-2">
...
export default forwardRef(ConsultaSubmitXmlModal)