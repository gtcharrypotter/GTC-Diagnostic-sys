...
import PatientVitalChartModal from "./vitals/PatientVitalChartModal";
...
const PatientVitals = (props) => {
	...
	const viewVitalRef = useRef(null);
			...
			{showTitle ? (
				...
				<div className="flex items-center gap-4 pb-2">
					...
					{vitals?.updated_at ? (
						...
						size="sm"
						onClick={() => {
							viewVitalRef.current.show(patient, appointment);
							// setUpdate(true);
						}}
						>
							<FlatIcon icon="rr-edit" className="mr-1" />
