...
const UploadRBSModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		formdata.append("rbs_mmol", data?.rbs_mmol);
		formdata.append("patient_rbs_remarks", data?.patient_rbs_remarks);
		Axios.post(`v1/laboratory/rbs-lab-result/${showData?.id}`, formdata)
			.then((res) => {
				reset();
