...
import { calculateAgeV3, doctorName, doctorSpecialty, formatCurrency, formatDateTime } from '../../../libs/helpers';
...
const PatientBillingDischarge = (props) => {
    const { loading: btnLoading, appointment, patient, onSaveCashierDischarge } = props;
	const { user } = useAuth();
	const [loading, setLoading] = useState(true);
	const [downloadUrl, setDownloadUrl] = useState(null);
	const [isEncryptGenerated, setIsEncryptGenerated] = useState(false);
	const [isDecryptGenerated, setIsDecryptGenerated] = useState(false);
	const [isSoaGenerated, setIsSoaGenerated] = useState(false);
	...
	const handleGenerateEKonsulta = async () => {
    try {
  ...
  const handleGenerateDecrypt = async () => {
    try {
  ...
  const handleGenerateESOA = async () => {
    try {
	...
	const handleSave = () => {
		if (onSaveCashierDischarge) {
			onSaveCashierDischarge();
		}
	...
	console.log("Patient Appointment Data", appointment)
  return (
   <div className="relative">	
			<div className="border shadow ">
				<div className="text-justify" ref={componentRef}>
                    ...
                    <div className="text-base text-center font-semibold mt-8 ">
						<span>STATEMENT OF ACCOUNT</span>
					</div>
					<div className="text-base text-center font-semibold mb-4">
				...
				<div className="p-4 flex items-center justify-end">
					{/* <div className="flex flex-col mr-auto gap-2">
						...
						disabled={isSoaGenerated}
					>
						<FlatIcon icon="rr-magic-wand" />
						eSOA
...
export default PatientBillingDischarge
