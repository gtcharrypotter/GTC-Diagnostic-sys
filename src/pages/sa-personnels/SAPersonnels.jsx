...
import PersonnelFormModal from '../rhu-personnels/components/PersonnelFormModal';
import DoctorAssignmentModal from '../rhu-personnels/components/DoctorAssignmentModal';
import ActivatePersonnelModal from '../rhu-personnels/components/ActivatePersonnelModal';
import DeactivatePersonnelModal from '../rhu-personnels/components/DeactivatePersonnelModal';
const uniq_id = uuidv4();
const SAPersonnels = (props) => {
    ...
    const getSaList = () => {
		Axios.get(`v1/health-unit/list?type=SA`).then((res) => {
			setSAList(res.data.data);
		});
	};
