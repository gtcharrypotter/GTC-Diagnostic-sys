...
const PersonnelFormModal = (props, ref) => {
	...
	const show = (showData = null) => {
		...
		setTimeout(() => {
			...
			if (showData?.id) {
				setValue("firstname", showData?.firstname);
				setValue("middlename", showData?.middlename);
				setValue("lastname", showData?.lastname);
				setValue("suffix", showData?.suffix);
				setValue("accreditation_number", showData?.accreditation_number);
				setValue("ptr_number", showData?.ptr_number);
				setValue("expiry_number", showData?.expiry_number);
	...
	const submit = (data) => {
		...
		formData.append("accreditation_number", data?.accreditation_number);
		formData.append("ptr_number", data?.ptr_number);
