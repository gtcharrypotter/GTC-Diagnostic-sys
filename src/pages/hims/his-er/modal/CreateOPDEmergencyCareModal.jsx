...
import { accessWasteOptions, diabetesSymptoms, diarrheaSymptoms, environmentalHistories, generalHistories, hypertensionSymptoms, lRISymptoms, malariaSymptoms, medicalSurgicalHistories, sanitaryOptions, symptoms, symptoms2, uRISymptoms } from "../../../../libs/appointmentOptions";
...
const CreateOPDEmergencyCareModal = (props, ref) => {
    const { onSuccess, patientSelfie, referToRHURef, patient } = props;
...
export default forwardRef(CreateOPDEmergencyCareModal)
