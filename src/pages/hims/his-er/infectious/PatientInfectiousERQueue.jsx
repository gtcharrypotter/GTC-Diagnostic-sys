...
import InserviceInfectiousER from './components/InserviceInfectiousER';
...
const PatientInfectiousERQueue = () => {
  const { user } = useAuth();
	const {
	...
	const handleORQueueClick = (queue) => {
...
export default PatientInfectiousERQueue
