...
import { calculateAge, formatDate, formatDateMMDDYYYY, formatDateMMDDYYYYHHIIA, formatDateWithOffset, patientFullName } from '../../../../../libs/helpers';
...
const EKASForm = ({}) => {
  ...
  useNoBugUseEffect({
	...
	const handleSavePBEFXML = async () => {
    setCanPrint(true);
  };
  console.log("Konsulta detatils", appointment)
  return (
