...
import useICUQueue from '../../../../../hooks/useICUQueue';
...
import AppointmentDetailsForICU from './components/AppointmentDetailsForICU';
import useNoBugUseEffect from '../../../../../hooks/useNoBugUseEffect';

const PatientICUQueue = () => {
   const { user } = useAuth();
	const { pending, mutatePending } = useICUQueue();
				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-5 divide-x">
					<div className="lg:col-span-4">
						...
						<span className="noto-sans-thin text-slate-500 text-sm font-light">
							Patients pending for icu approval
						</span>
...
export default PatientICUQueue
