...
const AppointmentDetailsForICU = ({
			...
			{appointment?.id ? (
				<>
					<div className="flex flex-col gap-y-4 px-4 border-x border-b rounded-b-xl border-indigo-100 pt-5 pb-4">
						...
						<CollapseDiv
							defaultOpen={ false
								// (appointment.status == "pending-for-surgery-icu") || 
								// 	(appointment.status == "pending-for-delivery-icu")
							}
							withCaret={true}
...
export default AppointmentDetailsForICU
