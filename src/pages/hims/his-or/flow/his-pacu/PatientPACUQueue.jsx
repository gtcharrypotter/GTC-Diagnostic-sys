...
import usePACUQueue from '../../../../../hooks/usePACUQueue';
...
const PatientPACUQueue = () => {
  const { user } = useAuth();
	const { pending, mutatePending } = usePACUQueue();
				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-5 divide-x">
					<div className="lg:col-span-4">
						...
						<span className="noto-sans-thin text-slate-500 text-sm font-light">
							Patients pending for pacu approval
						</span>
...
export default PatientPACUQueue
