...
import PatientDeliveryServices from './PatientDeliveryServices';
import ResuApproval from './ResuApproval';
import AddCsr from '../../../components/AddCsr';
import AddPharmacy from '../../../components/AddPharmacy';
import PatientVitals from '../../../../../../components/PatientVitals';
import TextInputField from '../../../../../../components/inputs/TextInputField';
import PatientDeliverySchedule from './PatientDeliverySchedule';
...
const AppointmentDetailsForDelivery = ({
				...
				<>
					<div className="flex flex-col gap-y-4 px-4 border-x border-b rounded-b-xl border-indigo-100 pt-5 pb-4">
						...
						{!hideServices ? (
							<CollapseDiv
								defaultOpen={
									(appointment.status == "pending-for-delivery-services")
								}
								withCaret={true}
								title="Services"
								headerClassName="bg-blue-50"
...
export default AppointmentDetailsForDelivery
