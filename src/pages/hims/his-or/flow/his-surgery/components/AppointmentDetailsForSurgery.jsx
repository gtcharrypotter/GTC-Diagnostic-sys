...
import PatientSurgeryQueue from '../PatientSurgeryQueue';
import PatientSurgeryServices from './PatientSurgeryServices';
import ResuApproval from '../../his-delivery/components/ResuApproval';
import AddCsr from '../../../components/AddCsr';
import AddPharmacy from '../../../components/AddPharmacy';
import PatientVitals from '../../../../../../components/PatientVitals';
import TextInputField from '../../../../../../components/inputs/TextInputField';
import PatientSurgerySchedule from '../PatientSurgerySchedule';
...
const AppointmentDetailsForSurgery = ({
				...
				<>
					<div className="flex flex-col gap-y-4 px-4 border-x border-b rounded-b-xl border-indigo-100 pt-5 pb-4">
						...
						{showService ? (
							<CollapseDiv
								defaultOpen={
									(appointment.status == "pending-for-surgery")
								}
								withCaret={true}
								title="Schedule"
								headerClassName="bg-blue-50"
						...
						{!hideServices ? (
							<CollapseDiv
								defaultOpen={
									(appointment.status == "pending-for-surgery-services")
								}
								withCaret={true}
								title="Services"
								headerClassName="bg-blue-50"
