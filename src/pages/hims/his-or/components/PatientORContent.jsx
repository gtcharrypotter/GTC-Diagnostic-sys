...
const PatientORContent = ({ patient }) => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
			...
			<CollapseDiv
				defaultOpen={true}
				title="III. MEDICAL HISTORY AND PHYSICAL EXAMINATION"
			>
			...
			<CollapseDiv defaultOpen={true} title="IV. PSYCHOLOGICAL EXAM">
...
export default PatientORContent
