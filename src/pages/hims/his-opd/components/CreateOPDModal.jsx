...
import { accessWasteOptions, diabetesSymptoms, diarrheaSymptoms, environmentalHistories, generalConsultation, generalHistories, hypertensionSymptoms, lRISymptoms, malariaSymptoms, medicalSurgicalHistories, sanitaryOptions, symptoms, symptoms2, uRISymptoms } from '../../../../libs/appointmentOptions';
...
const CreateOPDModal = (props, ref) => {
    const { onSuccess, patientSelfie, referToRHURef, appointment } = props;
	...
	const submit = (data) => {
		...
		formData1.append("for_opd", user?.health_unit_id);
...
export default forwardRef(CreateOPDModal)
