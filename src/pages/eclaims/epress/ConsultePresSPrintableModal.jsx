...
const ConsultePresSPrintableModal = (props, ref) => {
			...
			<Dialog as="div" className="" onClose={hide}>
                ...
                <div className="bg-gray-600 p-11 min-h-[14in]  overflow-auto phic-forms">
                        <ActionBtn
                          ...
                          <div className="bg-white p-[0.5in] w-[10.5in] gap-y-6 mx-auto"
...
export default forwardRef(ConsultePresSPrintableModal)
