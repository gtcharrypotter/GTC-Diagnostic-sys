...
import PatientAnesthesiaServices from './PatientAnesthesiaServices';
...
import PatientAnesthesiaSchedule from './PatientAnesthesiaSchedule';
...
const AppointmentDetailsForAnesthesia = ({
				...
				<>
					<div className="flex flex-col gap-y-4 px-4 border-x border-b rounded-b-xl border-indigo-100 pt-5 pb-4">
						...
						{showService ? (
							<CollapseDiv
								defaultOpen={
									(appointment.status == "pending-for-anesthesia-schedule")
								}
								withCaret={true}
								title="Schedule"
								headerClassName="bg-blue-50"
						...
						{!hideServices ? (
							<CollapseDiv
								defaultOpen={
									(appointment.status == "pending-for-anesthesia-service")
								}
								withCaret={true}
								title="Services"
								headerClassName="bg-blue-50"
...
export default AppointmentDetailsForAnesthesia
