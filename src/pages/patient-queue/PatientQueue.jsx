...
import InQueueForPharmacy from "./components/InQueueForPharmacy";
				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-5 divide-x">
					<div className="lg:col-span-4">
						...
						<div className="flex flex-col gap-y-4 py-4">
							...
							{pendingForResuRelease?.data?.map((queue, index) => {
								return (
									<InQueueForPharmacy
										selected={queue?.id == appointment?.id}
										onClick={() => {
									...
									>
										<div className="w-full flex flex-col pl-16">
											<div className="flex flex-col text-slate-700 gap-2 mb-2">
												<span className="text-sm">
													Status:
												</span>
												<span className="font-bold text-sm text-green-600">
													PENDING FOR PRESCRIPTION
												</span>
												<span className="text-sm">
													Room:
												</span>
