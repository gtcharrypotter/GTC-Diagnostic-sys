...
import InServiceOpd from '../hims/his-opd/components/InServiceOpd';
...
const OPDPatientQueue = () => {
	...
	console.log("PROFILE", appointment?.qr_code)
  return (
    <AppLayout>
								...
								<Fade key={`order-${appointment?.id}`}>
									<div>
										...
										<div className="flex flex-col lg:flex-row gap-2 border-x border-indigo-100 p-4">
											<PatientInfo patient={appointment?.patient} appointment={appointment}/>
...
export default OPDPatientQueue
