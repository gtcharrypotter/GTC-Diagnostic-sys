...
import { calculateAgeInMonths, calculateBMI, calculateBPMeasurement, dateYYYYMMDD, keyByValue } from '../../../libs/helpers';
...
import { abdomenLib, alcoholHist, bloodTypes, chestLib, digitalRectalLib, drugsHist, facilityTypeRBS, familyHistory, fbsChecker, generalSurveyPE, genitourinaryLib, heartLib, heentLib, immunizationAdult, immunizationChildren, immunizationElder, immunizationPregnant, infectiousSymptoms, medicalHistories, neuroLib, rbsChecker, sexualHist, skinLib, smokingHist } from '../../../libs/appointmentOptions';
...
const NewEncounterModal = (props, ref) => {
        ...
        const diabetesSelected = watch("diabetes_mellitus_family");
							...
							<Dialog.Panel className="w-full lg:max-w-[75vw] transform overflow-visible rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								>
									<span className="text-xl font-bold  text-blue-900">
										New Encounter (Health Screeaning & Assessment)
									</span>
									<span className="text-sm font-light text-blue-900 ">
										Complete form for new encounter (health screening & assessment)
									</span>
													...
													<div className="border shadow-md rounded-md">
														<div className="flex border bg-sky-500 rounded-md">
															...
															<div className="flex items-center gap-2 ml-auto p-2">
																...
																<label
																	key={option.value}
																	className="flex items-center gap-2 text-sm text-black cursor-pointer hover:text-white"
																>
																	<input
																	type="radio"
																	value={option.value}
...
export default forwardRef(NewEncounterModal)
